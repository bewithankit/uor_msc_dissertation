...
cf1 = axlist[0].contourf(trend_summary_1901_2014_max_0p2[1],lat,trend_summary_1901_2014_max_0p2[0]*10,np.linspace(-2,2,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
axlist[0].set_title('0.2x ensemble member mean\n',fontsize=16)
cf2 = axlist[1].contourf(trend_summary_1901_2014_max_0p4[1],lat,trend_summary_1901_2014_max_0p4[0]*10,np.linspace(-2,2,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
axlist[1].set_title('0.4x ensemble member mean\n',fontsize=16)
cf3 = axlist[2].contourf(trend_summary_1901_2014_max_0p7[1],lat,trend_summary_1901_2014_max_0p7[0]*10,np.linspace(-2,2,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
axlist[2].set_title('\n(1901-2014)\n\n0.7x ensemble member mean\n',fontsize=16)
cf4 = axlist[3].contourf(trend_summary_1901_2014_max_1p0[1],lat,trend_summary_1901_2014_max_1p0[0]*10,np.linspace(-2,2,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
axlist[3].set_title('1.0x ensemble member mean\n',fontsize=16)
cf5 = axlist[4].contourf(trend_summary_1901_2014_max_1p5[1],lat,trend_summary_1901_2014_max_1p5[0]*10,np.linspace(-2,2,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
axlist[4].set_title('1.5x ensemble member mean\n',fontsize=16)

cf6 = axlist[5].contourf(trend_summary_1951_1980_max_0p2[1],lat,trend_summary_1951_1980_max_0p2[0]*10,np.linspace(-2,2,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
cf7 = axlist[6].contourf(trend_summary_1951_1980_max_0p4[1],lat,trend_summary_1951_1980_max_0p4[0]*10,np.linspace(-2,2,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
cf8 = axlist[7].contourf(trend_summary_1951_1980_max_0p7[1],lat,trend_summary_1951_1980_max_0p7[0]*10,np.linspace(-2,2,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
axlist[7].set_title('\n(1951-1980)\n',fontsize=16)
cf9 = axlist[8].contourf(trend_summary_1951_1980_max_1p0[1],lat,trend_summary_1951_1980_max_1p0[0]*10,np.linspace(-2,2,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
cf10 = axlist[9].contourf(trend_summary_1951_1980_max_1p5[1],lat,trend_summary_1951_1980_max_1p5[0]*10,np.linspace(-2,2,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")

cf11 = axlist[10].contourf(trend_summary_1981_2014_max_0p2[1],lat,trend_summary_1981_2014_max_0p2[0]*10,np.linspace(-2,2,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
cf12 = axlist[11].contourf(trend_summary_1981_2014_max_0p4[1],lat,trend_summary_1981_2014_max_0p4[0]*10,np.linspace(-2,2,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
cf13 = axlist[12].contourf(trend_summary_1981_2014_max_0p7[1],lat,trend_summary_1981_2014_max_0p7[0]*10,np.linspace(-2,2,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
axlist[12].set_title('\n(1981-2014)\n',fontsize=16)
cf14 = axlist[13].contourf(trend_summary_1981_2014_max_1p0[1],lat,trend_summary_1981_2014_max_1p0[0]*10,np.linspace(-2,2,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
cf15 = axlist[14].contourf(trend_summary_1981_2014_max_1p5[1],lat,trend_summary_1981_2014_max_1p5[0]*10,np.linspace(-2,2,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
