...
fig.suptitle('MAM Seasonal Temperature Trends\n', fontsize=30)
...
plt.savefig('/Users/ankit/Documents/UoR/Dissertation/mam_trend_lowres_v2.png', format='png', dpi=1200, bbox_inches='tight')
plt.show()