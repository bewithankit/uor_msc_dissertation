...
fig.suptitle('SON Seasonal Temperature Trends\n', fontsize=30)
...
plt.savefig('/Users/ankit/Documents/UoR/Dissertation/son_trend_lowres_v2.png', format='png', dpi=1200, bbox_inches='tight')
plt.show()