...
fig.suptitle('MAM Maximum Temperature Trend', fontsize=30)
...
plt.savefig('/storage/silver/metstudent/msc/users_2022/ty824157/SMURPHS/ensemble_MAM_max_trend_cyclic.png', format='png', dpi=1200, bbox_inches='tight')
plt.show()
...
fig.suptitle('MAM Minimum Temperature Trend', fontsize=30)
...
plt.savefig('/storage/silver/metstudent/msc/users_2022/ty824157/SMURPHS/ensemble_MAM_min_trend_cyclic.png', format='png', dpi=1200, bbox_inches='tight')
plt.show()
...
fig.suptitle('MAM Diurnal Temperature Range Trend', fontsize=30)
...
plt.savefig('/storage/silver/metstudent/msc/users_2022/ty824157/SMURPHS/ensemble_MAM_dtr_trend_cyclic.png', format='png', dpi=1200, bbox_inches='tight')
plt.show()