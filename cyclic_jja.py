...
fig.suptitle('DJF Maximum Temperature Trend', fontsize=30)
...
plt.savefig('/storage/silver/metstudent/msc/users_2022/ty824157/SMURPHS/ensemble_DJF_max_trend_cyclic.png', format='png', dpi=1200, bbox_inches='tight')
plt.show()
...
fig.suptitle('DJF Minimum Temperature Trend', fontsize=30)
...
plt.savefig('/storage/silver/metstudent/msc/users_2022/ty824157/SMURPHS/ensemble_DJF_min_trend_cyclic.png', format='png', dpi=1200, bbox_inches='tight')
plt.show()
...
fig.suptitle('DJF Diurnal Temperature Range Trend', fontsize=30)
...
plt.savefig('/storage/silver/metstudent/msc/users_2022/ty824157/SMURPHS/ensemble_DJF_dtr_trend_cyclic.png', format='png', dpi=1200, bbox_inches='tight')
plt.show()