...
annual_tmax_0p2 = tmax_rol_0p2[0::12].groupby('time.year').mean('time')
tas_land_min_0p2=(annual_tmax_0p2*landfrac).weighted(weights*landfrac).mean(("lat", "lon"))
...
annual_tmin_0p2 = tmin_rol_0p2[0::12].groupby('time.year').mean('time')
...
annual_tmax_0p4 = tmax_rol_0p4[0::12].groupby('time.year').mean('time')
...
annual_tmin_0p4 = tmin_rol_0p4[0::12].groupby('time.year').mean('time')
...
annual_tmax_0p7 = tmax_rol_0p7[0::12].groupby('time.year').mean('time')
...
annual_tmin_0p7 = tmin_rol_0p7[0::12].groupby('time.year').mean('time')
...
annual_tmax_1p0 = tmax_rol_1p0[0::12].groupby('time.year').mean('time')
...
annual_tmin_1p0 = tmin_rol_1p0[0::12].groupby('time.year').mean('time')
...
annual_tmax_1p5 = tmax_rol_1p5[0::12].groupby('time.year').mean('time')
...
annual_tmin_1p5 = tmin_rol_1p5[0::12].groupby('time.year').mean('time')
...
ax.set(title='Mean DJF Diurnal Temperature Range (DTR)\n variation for high latitudes (>70$^\circ$N) (1901-2014)',
