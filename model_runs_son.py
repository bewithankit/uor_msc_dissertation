...
jja_min=tmin_rol[9::12].groupby('time.year').mean('time')
...
jja_dtr=dtr_rol[9::12].groupby('time.year').mean('time')
...
axlist[4].set_title('SON Minimum Temperature Trend\nr1 member mean (1951-1980)',fontsize=16)
...
axlist[5].set_title('SON Minimum Temperature Trend\nr1 member mean (1981-2014)',fontsize=16)
...
axlist[7].set_title('SON DTR Trend\nr1 member mean (1951-1980)',fontsize=16)
...
axlist[8].set_title('SON DTR Trend\nr1 member mean (1981-2014)',fontsize=16)
...
plt.savefig('/storage/silver/metstudent/msc/users_2022/ty824157/SMURPHS/SON_trend_r1.png', format='png', dpi=1200, bbox_inches='tight')
plt.show()
...
plt.savefig('/storage/silver/metstudent/msc/users_2022/ty824157/SMURPHS/SON_trend_r2.png', format='png', dpi=1200, bbox_inches='tight')
plt.show()
...
plt.savefig('/storage/silver/metstudent/msc/users_2022/ty824157/SMURPHS/SON_trend_r3.png', format='png', dpi=1200, bbox_inches='tight')
plt.show()
...
plt.savefig('/storage/silver/metstudent/msc/users_2022/ty824157/SMURPHS/SON_trend_r4.png', format='png', dpi=1200, bbox_inches='tight')
plt.show()
...
plt.savefig('/storage/silver/metstudent/msc/users_2022/ty824157/SMURPHS/SON_trend_r5.png', format='png', dpi=1200, bbox_inches='tight')
plt.show()
