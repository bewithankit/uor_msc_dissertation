...
def calc_summary_trend_dtr(temp_max_1, temp_min_1, temp_max_2, temp_min_2, year1, year2):
    ...
    global_dtr_1=((temp_max_1["tmx"]) - (temp_min_1["tmn"]))
    dtr_rol_1 = global_dtr_1.rolling(min_periods=3, center=True, time=3).mean()
...
trend_summary_1901_2014_dtr_0p2 = calc_summary_trend_dtr(temp_max_obs, temp_min_obs, temp_max_0p2, temp_min_0p2, 1900, 2015)
trend_summary_1901_2014_dtr_0p4 = calc_summary_trend_dtr(temp_max_obs, temp_min_obs, temp_max_0p4, temp_min_0p4, 1900, 2015)
trend_summary_1901_2014_dtr_0p7 = calc_summary_trend_dtr(temp_max_obs, temp_min_obs, temp_max_0p7, temp_min_0p7, 1900, 2015)
trend_summary_1901_2014_dtr_1p0 = calc_summary_trend_dtr(temp_max_obs, temp_min_obs, temp_max_1p0, temp_min_1p0, 1900, 2015)
trend_summary_1901_2014_dtr_1p5 = calc_summary_trend_dtr(temp_max_obs, temp_min_obs, temp_max_1p5, temp_min_1p5, 1900, 2015)

trend_summary_1951_1980_dtr_0p2 = calc_summary_trend_dtr(temp_max_obs, temp_min_obs, temp_max_0p2, temp_min_0p2, 1950, 1981)
trend_summary_1951_1980_dtr_0p4 = calc_summary_trend_dtr(temp_max_obs, temp_min_obs, temp_max_0p4, temp_min_0p4, 1950, 1981)
trend_summary_1951_1980_dtr_0p7 = calc_summary_trend_dtr(temp_max_obs, temp_min_obs, temp_max_0p7, temp_min_0p7, 1950, 1981)
trend_summary_1951_1980_dtr_1p0 = calc_summary_trend_dtr(temp_max_obs, temp_min_obs, temp_max_1p0, temp_min_1p0, 1950, 1981)
trend_summary_1951_1980_dtr_1p5 = calc_summary_trend_dtr(temp_max_obs, temp_min_obs, temp_max_1p5, temp_min_1p5, 1950, 1981)

trend_summary_1981_2014_dtr_0p2 = calc_summary_trend_dtr(temp_max_obs, temp_min_obs, temp_max_0p2, temp_min_0p2, 1980, 2015)
trend_summary_1981_2014_dtr_0p4 = calc_summary_trend_dtr(temp_max_obs, temp_min_obs, temp_max_0p4, temp_min_0p4, 1980, 2015)
trend_summary_1981_2014_dtr_0p7 = calc_summary_trend_dtr(temp_max_obs, temp_min_obs, temp_max_0p7, temp_min_0p7, 1980, 2015)
trend_summary_1981_2014_dtr_1p0 = calc_summary_trend_dtr(temp_max_obs, temp_min_obs, temp_max_1p0, temp_min_1p0, 1980, 2015)
trend_summary_1981_2014_dtr_1p5 = calc_summary_trend_dtr(temp_max_obs, temp_min_obs, temp_max_1p5, temp_min_1p5, 1980, 2015)
...
cf1 = axlist[0].contourf(trend_summary_1901_2014_dtr_0p2[1],lat,trend_summary_1901_2014_dtr_0p2[0]*10,np.linspace(-2,2,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
axlist[0].set_title('0.2x ensemble member mean\n',fontsize=16)
cf2 = axlist[1].contourf(trend_summary_1901_2014_dtr_0p4[1],lat,trend_summary_1901_2014_dtr_0p4[0]*10,np.linspace(-2,2,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
axlist[1].set_title('0.4x ensemble member mean\n',fontsize=16)
cf3 = axlist[2].contourf(trend_summary_1901_2014_dtr_0p7[1],lat,trend_summary_1901_2014_dtr_0p7[0]*10,np.linspace(-2,2,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
axlist[2].set_title('\n(1901-2014)\n\n0.7x ensemble member mean\n',fontsize=16)
cf4 = axlist[3].contourf(trend_summary_1901_2014_dtr_1p0[1],lat,trend_summary_1901_2014_dtr_1p0[0]*10,np.linspace(-2,2,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
axlist[3].set_title('1.0x ensemble member mean\n',fontsize=16)
cf5 = axlist[4].contourf(trend_summary_1901_2014_dtr_1p5[1],lat,trend_summary_1901_2014_dtr_1p5[0]*10,np.linspace(-2,2,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
axlist[4].set_title('1.5x ensemble member mean\n',fontsize=16)

cf6 = axlist[5].contourf(trend_summary_1951_1980_dtr_0p2[1],lat,trend_summary_1951_1980_dtr_0p2[0]*10,np.linspace(-2,2,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
cf7 = axlist[6].contourf(trend_summary_1951_1980_dtr_0p4[1],lat,trend_summary_1951_1980_dtr_0p4[0]*10,np.linspace(-2,2,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
cf8 = axlist[7].contourf(trend_summary_1951_1980_dtr_0p7[1],lat,trend_summary_1951_1980_dtr_0p7[0]*10,np.linspace(-2,2,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
axlist[7].set_title('\n(1951-1980)\n',fontsize=16)
cf9 = axlist[8].contourf(trend_summary_1951_1980_dtr_1p0[1],lat,trend_summary_1951_1980_dtr_1p0[0]*10,np.linspace(-2,2,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
cf10 = axlist[9].contourf(trend_summary_1951_1980_dtr_1p5[1],lat,trend_summary_1951_1980_dtr_1p5[0]*10,np.linspace(-2,2,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")

cf11 = axlist[10].contourf(trend_summary_1981_2014_dtr_0p2[1],lat,trend_summary_1981_2014_dtr_0p2[0]*10,np.linspace(-2,2,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
cf12 = axlist[11].contourf(trend_summary_1981_2014_dtr_0p4[1],lat,trend_summary_1981_2014_dtr_0p4[0]*10,np.linspace(-2,2,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
cf13 = axlist[12].contourf(trend_summary_1981_2014_dtr_0p7[1],lat,trend_summary_1981_2014_dtr_0p7[0]*10,np.linspace(-2,2,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
axlist[12].set_title('\n(1981-2014)\n',fontsize=16)
cf14 = axlist[13].contourf(trend_summary_1981_2014_dtr_1p0[1],lat,trend_summary_1981_2014_dtr_1p0[0]*10,np.linspace(-2,2,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
cf15 = axlist[14].contourf(trend_summary_1981_2014_dtr_1p5[1],lat,trend_summary_1981_2014_dtr_1p5[0]*10,np.linspace(-2,2,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")

fig.suptitle('DJF Diurnal Temperature Range Trend: Model and Observation difference', fontsize=30)
...
plt.savefig('/storage/silver/metstudent/msc/users_2022/ty824157/SMURPHS/DJF_model-obs_dtr.png', format='png', dpi=1200, bbox_inches='tight')
plt.show()
...
def calc_summary_trend_dtr(temp_max_1, temp_min_1, temp_max_2, temp_min_2, year1, year2):
    ...
    global_dtr_1=((temp_max_1["tmx"]) - (temp_min_1["tmn"]))
    dtr_rol_1 = global_dtr_1.rolling(min_periods=3, center=True, time=3).mean()
    jja_1=dtr_rol_1[3::12].groupby('time.year').mean('time')
    mask_1=((jja_1.year > year1) & (jja_1.year < year2))
    trend_ds_1=jja_1[mask_1].polyfit(dim='year',deg=1,skipna=True)
    trend_1 = trend_ds_1['polyfit_coefficients'][0]
    ...
    global_dtr_2=((temp_max_2["tasmax"] - 273.15) - (temp_min_2["tasmin"] - 273.15))
    dtr_rol_2 = global_dtr_2.rolling(min_periods=3, center=True, time=3).mean().mean('members')
    jja_2=dtr_rol_2[3::12].groupby('time.year').mean('time')
    mask_2=((jja_2.year > year1) & (jja_2.year < year2))
    trend_ds_2=jja_2[mask_2].polyfit(dim='year',deg=1,skipna=True)
    trend_2 = trend_ds_2['polyfit_coefficients'][0]
...
fig.suptitle('MAM Diurnal Temperature Range Trend: Model and Observation difference', fontsize=30)
...
plt.savefig('/storage/silver/metstudent/msc/users_2022/ty824157/SMURPHS/MAM_model-obs_dtr.png', format='png', dpi=1200, bbox_inches='tight')
plt.show()
...
def calc_summary_trend_dtr(temp_max_1, temp_min_1, temp_max_2, temp_min_2, year1, year2):
    ...
    global_dtr_1=((temp_max_1["tmx"]) - (temp_min_1["tmn"]))
    dtr_rol_1 = global_dtr_1.rolling(min_periods=3, center=True, time=3).mean()
    jja_1=dtr_rol_1[6::12].groupby('time.year').mean('time')
    mask_1=((jja_1.year > year1) & (jja_1.year < year2))
    trend_ds_1=jja_1[mask_1].polyfit(dim='year',deg=1,skipna=True)
    trend_1 = trend_ds_1['polyfit_coefficients'][0]
    ...
    global_dtr_2=((temp_max_2["tasmax"] - 273.15) - (temp_min_2["tasmin"] - 273.15))
    dtr_rol_2 = global_dtr_2.rolling(min_periods=3, center=True, time=3).mean().mean('members')
    jja_2=dtr_rol_2[6::12].groupby('time.year').mean('time')
    mask_2=((jja_2.year > year1) & (jja_2.year < year2))
    trend_ds_2=jja_2[mask_2].polyfit(dim='year',deg=1,skipna=True)
    trend_2 = trend_ds_2['polyfit_coefficients'][0]
...
fig.suptitle('JJA Diurnal Temperature Range Trend: Model and Observation difference', fontsize=30)
...
plt.savefig('/storage/silver/metstudent/msc/users_2022/ty824157/SMURPHS/JJA_model-obs_dtr.png', format='png', dpi=1200, bbox_inches='tight')
plt.show()
...
def calc_summary_trend_dtr(temp_max_1, temp_min_1, temp_max_2, temp_min_2, year1, year2):
    ...
    global_dtr_1=((temp_max_1["tmx"]) - (temp_min_1["tmn"]))
    dtr_rol_1 = global_dtr_1.rolling(min_periods=3, center=True, time=3).mean()
    jja_1=dtr_rol_1[9::12].groupby('time.year').mean('time')
    mask_1=((jja_1.year > year1) & (jja_1.year < year2))
    trend_ds_1=jja_1[mask_1].polyfit(dim='year',deg=1,skipna=True)
    trend_1 = trend_ds_1['polyfit_coefficients'][0]
    ...
    global_dtr_2=((temp_max_2["tasmax"] - 273.15) - (temp_min_2["tasmin"] - 273.15))
    dtr_rol_2 = global_dtr_2.rolling(min_periods=3, center=True, time=3).mean().mean('members')
    jja_2=dtr_rol_2[9::12].groupby('time.year').mean('time')
    mask_2=((jja_2.year > year1) & (jja_2.year < year2))
    trend_ds_2=jja_2[mask_2].polyfit(dim='year',deg=1,skipna=True)
    trend_2 = trend_ds_2['polyfit_coefficients'][0]
...
fig.suptitle('SON Diurnal Temperature Range Trend: Model and Observation difference', fontsize=30)
...
plt.savefig('/storage/silver/metstudent/msc/users_2022/ty824157/SMURPHS/SON_model-obs_dtr.png', format='png', dpi=1200, bbox_inches='tight')
plt.show()