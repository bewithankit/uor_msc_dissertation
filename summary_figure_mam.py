...
def calc_tmin_trend_jja(temp_min, year1, year2):
    ...
    jja=tmin_rol[3::12].groupby('time.year').mean('time')
    mask=((jja.year > year1) & (jja.year < year2))
    trend_ds=jja[mask].polyfit(dim='year',deg=1,skipna=True)
    trend = trend_ds['polyfit_coefficients'][0]
    trend2,lon2 = add_cyclic_point(trend,lon,axis=1)
...
def calc_dtr_trend_jja(temp_max, temp_min, year1, year2):
    ...
    jja=dtr_rol[3::12].groupby('time.year').mean('time')
    mask=((jja.year > year1) & (jja.year < year2))
    trend_ds=jja[mask].polyfit(dim='year',deg=1,skipna=True)
    trend = trend_ds['polyfit_coefficients'][0]
    trend2,lon2 = add_cyclic_point(trend,lon,axis=1)
...
fig.suptitle('MAM Maximum Temperature Trend Summary\n', fontsize=30)
...
plt.savefig('/storage/silver/metstudent/msc/users_2022/ty824157/SMURPHS/summary_0p2_1p5_MAM_max_trend_new.png', format='png', dpi=1200, bbox_inches='tight')
plt.show()
...
fig.suptitle('MAM Minimum Temperature Trend Summary\n', fontsize=30)
...
plt.savefig('/storage/silver/metstudent/msc/users_2022/ty824157/SMURPHS/summary_0p2_1p5_MAM_min_trend_new.png', format='png', dpi=1200, bbox_inches='tight')
plt.show()
...
fig.suptitle('MAM Diurnal Temperature Range Trend Summary\n', fontsize=30)
...
plt.savefig('/storage/silver/metstudent/msc/users_2022/ty824157/SMURPHS/summary_0p2_1p5_MAM_dtr_trend_new.png', format='png', dpi=1200, bbox_inches='tight')
plt.show()
