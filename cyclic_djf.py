...
plt.savefig('/storage/silver/metstudent/msc/users_2022/ty824157/SMURPHS/ensemble_JJA_max_trend_cyclic.png', format='png', dpi=1200, bbox_inches='tight')
plt.show()
...
fig.suptitle('JJA Minimum Temperature Trend', fontsize=30)
...
plt.savefig('/storage/silver/metstudent/msc/users_2022/ty824157/SMURPHS/ensemble_JJA_min_trend_cyclic.png', format='png', dpi=1200, bbox_inches='tight')
plt.show()
...
fig.suptitle('JJA Diurnal Temperature Range Trend', fontsize=30)
...
plt.savefig('/storage/silver/metstudent/msc/users_2022/ty824157/SMURPHS/ensemble_JJA_dtr_trend_cyclic.png', format='png', dpi=1200, bbox_inches='tight')
plt.show()