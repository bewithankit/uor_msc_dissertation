...
fig.suptitle('JJA Maximum Temperature Trend Summary\n', fontsize=30)
...
plt.savefig('/storage/silver/metstudent/msc/users_2022/ty824157/SMURPHS/summary_0p2_1p5_JJA_max_trend_new.png', format='png', dpi=1200, bbox_inches='tight')
plt.show()
...
fig.suptitle('JJA Minimum Temperature Trend Summary\n', fontsize=30)
...
plt.savefig('/storage/silver/metstudent/msc/users_2022/ty824157/SMURPHS/summary_0p2_1p5_JJA_min_trend_new.png', format='png', dpi=1200, bbox_inches='tight')
plt.show()
...
fig.suptitle('JJA Diurnal Temperature Range Trend Summary\n', fontsize=30)
...
plt.savefig('/storage/silver/metstudent/msc/users_2022/ty824157/SMURPHS/summary_0p2_1p5_JJA_dtr_trend_new.png', format='png', dpi=1200, bbox_inches='tight')
plt.show()
