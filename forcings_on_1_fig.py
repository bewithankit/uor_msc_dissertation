...
def calc_tmax_trend_jja(temp_max, year1, year2):
    ...
    return trend_ds['polyfit_coefficients'][0]
...
def calc_tmin_trend_jja(temp_min, year1, year2):
    ...
    jja=tmin_rol[6::12].groupby('time.year').mean('time')
    mask=((jja.year > year1) & (jja.year < year2))
    trend_ds=jja[mask].polyfit(dim='year',deg=1,skipna=True)
    return trend_ds['polyfit_coefficients'][0]
...
def calc_dtr_trend_jja(temp_max, temp_min, year1, year2):
    ...
    jja=dtr_rol[6::12].groupby('time.year').mean('time')
    mask=((jja.year > year1) & (jja.year < year2))
    trend_ds=jja[mask].polyfit(dim='year',deg=1,skipna=True)
    return trend_ds['polyfit_coefficients'][0]
...
cf1 = axlist[0].contourf(lon,lat,trend_max_0p2_1901_2014*10,np.linspace(-1,1,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
axlist[0].set_title('0.2x ensemble member mean\n',fontsize=16)
axlist[0].set_ylabel('(1901-2014)',fontsize=18)
cf2 = axlist[1].contourf(lon,lat,trend_max_0p4_1901_2014*10,np.linspace(-1,1,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
axlist[1].set_title('0.4x ensemble member mean\n',fontsize=16)
cf3 = axlist[2].contourf(lon,lat,trend_max_0p7_1901_2014*10,np.linspace(-1,1,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
axlist[2].set_title('\n(1901-2014)\n\n0.7x ensemble member mean\n',fontsize=16)
cf4 = axlist[3].contourf(lon,lat,trend_max_1p0_1901_2014*10,np.linspace(-1,1,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
axlist[3].set_title('1.0x ensemble member mean\n',fontsize=16)
cf5 = axlist[4].contourf(lon,lat,trend_max_1p5_1901_2014*10,np.linspace(-1,1,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
axlist[4].set_title('1.5x ensemble member mean\n',fontsize=16)

cf6 = axlist[5].contourf(lon,lat,trend_max_0p2_1951_1980*10,np.linspace(-1,1,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
cf7 = axlist[6].contourf(lon,lat,trend_max_0p4_1951_1980*10,np.linspace(-1,1,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
cf8 = axlist[7].contourf(lon,lat,trend_max_0p7_1951_1980*10,np.linspace(-1,1,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
axlist[7].set_title('\n(1951-1980)\n',fontsize=18)
cf9 = axlist[8].contourf(lon,lat,trend_max_1p0_1951_1980*10,np.linspace(-1,1,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
cf10 = axlist[9].contourf(lon,lat,trend_max_1p5_1951_1980*10,np.linspace(-1,1,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")

cf11 = axlist[10].contourf(lon,lat,trend_max_0p2_1981_2014*10,np.linspace(-1,1,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
cf12 = axlist[11].contourf(lon,lat,trend_max_0p4_1981_2014*10,np.linspace(-1,1,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
cf13 = axlist[12].contourf(lon,lat,trend_max_0p7_1981_2014*10,np.linspace(-1,1,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
axlist[12].set_title('\n(1981-2014)\n',fontsize=18)
cf14 = axlist[13].contourf(lon,lat,trend_max_1p0_1981_2014*10,np.linspace(-1,1,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")
cf15 = axlist[14].contourf(lon,lat,trend_max_1p5_1981_2014*10,np.linspace(-1,1,41),transform=ccrs.PlateCarree(),cmap=plt.cm.RdBu_r,extend="both")

fig.suptitle('JJA Maximum Temperature Trend', fontsize=30)
...
plt.savefig('/storage/silver/metstudent/msc/users_2022/ty824157/SMURPHS/ensemble_JJA_trend.png', format='png', dpi=1200, bbox_inches='tight')
plt.show()