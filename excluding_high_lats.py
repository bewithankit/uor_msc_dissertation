...
annual_tmax_0p2 = temp_max_0p2.groupby('time.year').mean('time').mean('members')
...
annual_tmin_0p2 = temp_min_0p2.groupby('time.year').mean('time').mean('members')
...
annual_tmax_0p4 = temp_max_0p4.groupby('time.year').mean('time').mean('members')
...
annual_tmin_0p4 = temp_min_0p4.groupby('time.year').mean('time').mean('members')
...
annual_tmax_0p7 = temp_max_0p7.groupby('time.year').mean('time').mean('members')
...
annual_tmin_0p7 = temp_min_0p7.groupby('time.year').mean('time').mean('members')
...
annual_tmax_1p0 = temp_max_1p0.groupby('time.year').mean('time').mean('members')
...
annual_tmin_1p0 = temp_min_1p0.groupby('time.year').mean('time').mean('members')
...
annual_tmax_1p5 = temp_max_1p5.groupby('time.year').mean('time').mean('members')
...
annual_tmin_1p5 = temp_min_1p5.groupby('time.year').mean('time').mean('members')
...
fig.legend(bbox_to_anchor=[0.15, 0.40], loc='upper left', fontsize=8)

ax.set(title='Global mean Diurnal Temperature Range (DTR)\n variation excluding high latitudes (>70$^\circ$N) (1901-2014)',
     xlabel='Years', ylabel='$^\circ$C') 

plt.savefig('/Users/ankit/Documents/UoR/Dissertation/model_dtr_exluding_high_lats.png', format='png', dpi=1200)
